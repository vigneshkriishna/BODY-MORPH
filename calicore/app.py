...
# Page config: no sidebar, centered layout
st.set_page_config(page_title="CaliCore AI Planner", layout="centered", initial_sidebar_state="collapsed")

# --- Styling ---
st.markdown("""
    <style>
        /* Clean background & no white container */
        .css-1d391kg {padding: 0rem 2rem;} /* container padding */
        .block-container {padding-top: 1rem; padding-bottom: 2rem;}
        /* Remove default white container shadow & background */
        .css-18e3th9 {background-color: #f0f8ff !important; box-shadow: none !important; padding: 0 !important; margin: 0 auto;}
        /* Remove left sidebar */
...
st.markdown("""
    <div style='text-align: center; padding: 1.5em 0 1em 0;'>
        <h1>💪 CaliCore - AI Fitness & Gut Health Plan</h1>
        <p style='font-size: 1.1em; color: #555;'>Clean UI with no sidebar & no white container</p>
    </div>
""", unsafe_allow_html=True)
